...
object Licenser {
	...
	const val NUM_MONTHS = 2
	const val LICENSE_EXPIRY_MILLIS = MILLIS_PER_MONTH * NUM_MONTHS
	...
	private inline fun validateLicense(text: String): LicenseFile? {
		try {
			...
			if (currentTime - timestamp > LICENSE_EXPIRY_MILLIS) {
				println("Outdated license, please generate a new one")
				return null
			}
